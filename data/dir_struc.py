...
def print_directory_structure(root_path, max_files_per_folder=3, prefix="", is_last=True, ignore_hidden_folders=True):
    """
    ...
    Args:
        ...
        ignore_hidden_folders: Whether to ignore folders starting with "." (default: True)
    """
    ...
    # Filter out hidden folders if ignore_hidden_folders is True
    ...
    for i, item in enumerate(all_items):
        ...
        if os.path.isdir(item_path):
            ...
            print_directory_structure(item_path, max_files_per_folder, prefix + extension, is_last_item, ignore_hidden_folders)
        else:
            print(f"{prefix}{connector}{item}")
...
print_directory_structure(root_directory, max_files_per_folder=2, ignore_hidden_folders=True)